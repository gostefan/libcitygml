...
class FileReadTests : public ::testing::Test {};
...
TEST_F(FileReadTests, berlin_open_data_sample_data) {
	readFile("../../data/berlin_open_data_sample_data.citygml");
}

TEST_F(FileReadTests, b1_lod2_s) {
	readFile("../../data/b1_lod2_s.gml");
}

TEST_F(FileReadTests, FZK_Haus_LoD0_KIT_IAI_KHH_B36_V1) {
